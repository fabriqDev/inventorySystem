...
import type { CreateTransferInput, CreateTransferResult } from '@/core/backend/types';
import {
  acceptMockTransfer,
  cancelMockTransfer,
  createMockTransfer,
...
export async function cancelTransfer(
  ...
  if (useMock) return cancelMockTransfer(transferId);
  return backend.data.cancelTransfer(transferId);
}
